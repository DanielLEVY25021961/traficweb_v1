...
/**
 * CLASSE AnneeGestionTest :<br/>
 * Test JUnit de la classe {@link AnneeGestion}.<br/>
 * <br/>
 *
...
public class AnneeGestionTest {
	...
	public static transient IAnneeGestion objet1 
		= new AnneeGestion(1L, ANNEE_2018);
	...
	public static transient IAnneeGestion objet2EqualsObj1 
		=  new AnneeGestion(2L, ANNEE_2018);
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IAnneeGestion objet3EqualsObj1 
		= new AnneeGestion(3L, ANNEE_2018);
	...
	private static final Log LOG = LogFactory.getLog(AnneeGestionTest.class);
	...
	public void testToString() {
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "AnneeGestion [id=0, anneeGestion=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "AnneeGestion [id=1, anneeGestion=2018]"
						, objet1.toString());
...
} // Fin de CLASSE AnneeGestionTest._________________________________________
