...
/**
 * CLASSE UtilisateurCerbereEntityJPATest :<br/>
 * Test JUnit de la classe ENTITY {@link UtilisateurCerbereEntityJPA}.<br/>
 * <br/>
 *
 ...
 *
 */
public class UtilisateurCerbereEntityJPATest {
	...
	public static transient IUtilisateurCerbere objet2EqualsObj1 
		=  new UtilisateurCerbereEntityJPA(2L
				, M
				, PRENOMTEST, NOMTEST
				, "07 69 52 31 65"
				, MAILTEST
	...
	public static transient IUtilisateurCerbere objetNull1 
		= new UtilisateurCerbereEntityJPA(0L
				, null
				, null, null
				, null, null
				, null, null
	...
	public static transient IUtilisateurCerbere objetNull2 
		=  new UtilisateurCerbereEntityJPA(7L
				, null
				, null, null
				, null, null
				, null, null
	...
	public static transient IUtilisateurCerbere objet2EqualsObjet1AvecNull 
		= new UtilisateurCerbereEntityJPA(4L
				, "Mlle"
				, null, "nomTestavecNull"
				, "01 60 81 44 44", null
				, "SG", "SG"
	...
	private static final Log LOG 
		= LogFactory.getLog(UtilisateurCerbereEntityJPATest.class);
	 ...
	 */
	public UtilisateurCerbereEntityJPATest() {
		super();
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testClone() ********** ");
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testToString() ********** ");
		}
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "UtilisateurCerbereEntityJPA [id=0, civilite=null, prenom=null, nom=null, tel=null, email=null, service=null, unite=null, profil=null, portee=null, restriction=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "UtilisateurCerbereEntityJPA [id=1, civilite=M., prenom=prenomTest, nom=nomTest, tel=01 60 52 34 51, email=test.test@yahoo.fr, service=CEREMA, unite=CEREMA/DTecITM/CITS/DACSI, profil=ADMINISTRATEUR, portee=null, restriction=null]"
						, objet1.toString());
	...
	public void testFournirEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testFournirEnTeteCsv() ********** ");
		}
	...
	public void testFournirStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testFournirStringCsv() ********** ");
		}
	...
	public void testFournirEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testFournirEnTeteColonne() ********** ");
		}
	...
	public void testFournirValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereEntityJPATest - méthode testFournirValeurColonne() ********** ");
		}
...
} // FIN DE LA CLASSE UtilisateurCerbereEntityJPATest.-----------------------
