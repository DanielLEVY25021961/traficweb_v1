...
/**
 * CLASSE FactoryNomenclatureHistoF07Test :<br/>
 * Test JUnit de la classe {@link FactoryNomenclatureHistoF07}.<br/>
 * <br/>
 *
 ...
 *
 */
public class FactoryNomenclatureHistoF07Test {
	...
	/**
	 * FactoryNomenclatureHistoF07 à tester.
	 */
	public static final FactoryNomenclatureHistoF07 FACTORY_NOMENCLATURE_HISTO_F07 
		= new FactoryNomenclatureHistoF07();
	...
	private static final Log LOG 
		= LogFactory.getLog(FactoryNomenclatureHistoF07Test.class);
	 ...
	 */
	public FactoryNomenclatureHistoF07Test() {
		super();
	...
	public void testGetClesPossiblesSetInexistant() throws Exception {
		...
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetClesPossiblesSetInexistant() ********** ");
		}

		final Set<Integer> resultat 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(2);
	...
	public void testGetClesPossiblesSetLexiqueInexistant() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetClesPossiblesSetLexiqueInexistant() ********** ");
		}

		final Set<String> resultat 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSetLexique(2);
	...
	public void testGetClesPossiblesSet() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetClesPossiblesSet() ********** ");
		}
		
		/* SENS. */
		final Set<Integer> resultatSens 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(3);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesSens()
					, resultatSens);

		/* NATURE. */
		final Set<Integer> resultatNature 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(4);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesNature()
					, resultatNature);

		/* TYPE DE COMPTAGE. */
		final Set<Integer> resultatTypeComptage 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(9);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesTypeComptage()
					, resultatTypeComptage);

		/* CLASSEMENT DE LA ROUTE. */
		final Set<Integer> resultatClassementRoute 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(10);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesClassementRoute()
					, resultatClassementRoute);

		/* CLASSE DE LARGEUR DE CHAUSSEE UNIQUE. */
		final Set<Integer> resultatClasseLargeurChausseeU 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(11);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesClasseLargeurChausseeU()
					, resultatClasseLargeurChausseeU);

		/* CLASSE DE LARGEUR DE CHAUSSEES SEPAREES. */
		final Set<Integer> resultatClasseLargeurChausseesS 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(12);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesClasseLargeurChausseesS()
					, resultatClasseLargeurChausseesS);

		/* TYPE DE RESEAU. */
		final Set<Integer> resultatTypeReseau 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(13);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesTypeReseau()
					, resultatTypeReseau);

		/* SOUS-RESEAU INDICE. */
		final Set<Integer> resultatSousReseauIndice 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSet(97);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesSousReseauIndice()
	...
	public void testGetClesPossiblesSetLexique() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetClesPossiblesSetLexique() ********** ");
		}
		
		/* CODE CONCESSION SICRE. */
		final Set<String> resultatCodeConcessionSicre 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSetLexique(93);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesCodeConcessionSicre()
					, resultatCodeConcessionSicre);
		
		/* PROFIL EN TRAVERS SICRE. */
		final Set<String> resultatProfilTraversSicre 
			= FACTORY_NOMENCLATURE_HISTO_F07.getClesPossiblesSetLexique(96);
		...
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getSetClesPossiblesProfilTraversSicre()
	...
	public void testGetNomenclatureMapInexistant() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetNomenclatureMapInexistant() ********** ");
		}

		final Map<Integer, String> resultat 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(2);
	...
	public void testGetLexiqueMapInexistant() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetLexiqueMapInexistant() ********** ");
		}

		final Map<String, String> resultat 
			= FACTORY_NOMENCLATURE_HISTO_F07.getLexiqueMap(2);
	...
	public void testGetNomenclatureMap() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetNomenclatureMap() ********** ");
		}
		
		/* SENS. */
		final Map<Integer, String> resultatSens 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(3);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "SENS : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatSens));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatSens);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapSens()
					, resultatSens);

		/* NATURE. */
		final Map<Integer, String> resultatNature 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(4);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "NATURE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatNature));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatNature);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapNature()
					, resultatNature);

		/* TYPE DE COMPTAGE. */
		final Map<Integer, String> resultatTypeComptage 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(9);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "TYPE DE COMPTAGE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatTypeComptage));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatTypeComptage);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapTypeComptage()
					, resultatTypeComptage);

		/* CLASSEMENT DE LA ROUTE. */
		final Map<Integer, String> resultatClassementRoute 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(10);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "CLASSEMENT DE LA ROUTE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatClassementRoute));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatClassementRoute);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapClassementRoute()
					, resultatClassementRoute);

		/* CLASSE DE LARGEUR DE CHAUSSEE UNIQUE. */
		final Map<Integer, String> resultatClasseLargeurChausseeU 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(11);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "CLASSE DE LARGEUR DE CHAUSSEE UNIQUE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatClasseLargeurChausseeU));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatClasseLargeurChausseeU);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapClasseLargeurChausseeU()
					, resultatClasseLargeurChausseeU);

		/* CLASSE DE LARGEUR DE CHAUSSEES SEPAREES. */
		final Map<Integer, String> resultatClasseLargeurChausseesS 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(12);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "CLASSE DE LARGEUR DE CHAUSSEES SEPAREES : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatClasseLargeurChausseesS));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatClasseLargeurChausseesS);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapClasseLargeurChausseesS()
					, resultatClasseLargeurChausseesS);

		/* TYPE DE RESEAU. */
		final Map<Integer, String> resultatTypeReseau 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(13);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "TYPE DE RESEAU : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatTypeReseau));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatTypeReseau);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapTypeReseau()
					, resultatTypeReseau);

		/* SOUS-RESEAU INDICE. */
		final Map<Integer, String> resultatSousReseauIndice 
			= FACTORY_NOMENCLATURE_HISTO_F07.getNomenclatureMap(97);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "SOUS-RESEAU INDICE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapIntegerString(resultatSousReseauIndice));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatSousReseauIndice);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getNomenclatureMapSousReseauIndice()
					, resultatSousReseauIndice);
	...
	public void testGetLexiqueMap() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FactoryNomenclatureHistoF07Test - méthode testGetLexiqueMap() ********** ");
		}
		
		/* CODE CONCESSION SICRE. */
		final Map<String, String> resultatCodeConcessionSicre 
			= FACTORY_NOMENCLATURE_HISTO_F07.getLexiqueMap(93);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "CODE CONCESSION SICRE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapStringString(resultatCodeConcessionSicre));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatCodeConcessionSicre);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getLexiqueMapCodeConcessionSicre()
					, resultatCodeConcessionSicre);
		
		/* PROFIL EN TRAVERS SICRE. */
		final Map<String, String> resultatProfilTraversSicre 
			= FACTORY_NOMENCLATURE_HISTO_F07.getLexiqueMap(96);
		
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println();
			System.out.println(NOMENCLATURE_POUR + "PROFIL EN TRAVERS SICRE : ");
			System.out.print(FACTORY_NOMENCLATURE_HISTO_F07.afficherMapStringString(resultatProfilTraversSicre));
		}
		...
		assertNotNull(NE_DOIT_PAS_RETOURNER_NULL, resultatProfilTraversSicre);
		assertSame(DOIT_RETOURNER_BONNE_NOMENCLATURE
				, FactoryNomenclatureHistoF07.getLexiqueMapProfilTraversSicre()
					, resultatProfilTraversSicre);
...
} // FIN DE LA CLASSE FactoryNomenclatureHistoF07Test.-----------------------
