...
public class UtilisateurCerbereValideurServiceTest {
	...
	public void testValiderTel() throws Exception {
		...
		final String numTelBon1 = "03 84 41 80 47";    // NOPMD by daniel.levy on 15/05/19 12:15
		final String numTelBon2 = "03-84-41-80-47";    // NOPMD by daniel.levy on 15/05/19 12:15
		final String numTelBon3 = "03.84.41.80.47";    // NOPMD by daniel.levy on 15/05/19 12:16
		final String numTelBon4 = "0384418047";
		
		final String motif2Chiffres = "(\\d\\d)";
		final String motifTiretOuPointOuEspaceOuRien = "([\\-\\.\\x20])?";
		
		final String motifTelFrancais2     // NOPMD by daniel.levy on 15/05/19 12:16
