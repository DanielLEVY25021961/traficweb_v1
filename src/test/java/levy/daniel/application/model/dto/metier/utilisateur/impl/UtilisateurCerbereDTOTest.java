...
/**
 * CLASSE UtilisateurCerbereDTOTest :<br/>
 * Test JUnit de la classe DTO {@link UtilisateurCerbereDTO}.<br/>
 * <br/>
 *
 ...
 *
 */
public class UtilisateurCerbereDTOTest {
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objet1 
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objet1MemeInstance = objet1;
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IUtilisateurCerbereDTO objet2EqualsObj1 
		=  new UtilisateurCerbereDTO("2"
				, M
				, PRENOMTEST, NOMTEST
				, "07 69 52 31 65"
				, MAILTEST
	 ...
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IUtilisateurCerbereDTO objet3EqualsObj1 
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetNull1 
		= new UtilisateurCerbereDTO("0"
				, null
				, null, null
				, null, null
				, null, null
	 ...
	 * tous les attributs aux valeurs par défaut.
	 */
	public static transient IUtilisateurCerbereDTO objetNull2 
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objet1AvecNull 
		= new UtilisateurCerbereDTO("3"
				, "Mlle"
	 ...
	 * doivent être equals() et avoir certains attributs à null.
	 */
	public static transient IUtilisateurCerbereDTO objet2EqualsObjet1AvecNull 
		= new UtilisateurCerbereDTO("4"
				, "Mlle"
				, null, "nomTestavecNull"
				, "01 60 81 44 44", null
				, "SG", "SG"
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetDiff1 
		= new UtilisateurCerbereDTO("4"
				, M
				, "Laurent", "Sergent"
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetDiff2 
		= new UtilisateurCerbereDTO("1"
				, "Mme"
				, "Melanie", "Daisy"
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetDiff1AvecNull 
		= new UtilisateurCerbereDTO("1"
				, M
				, null, "SergentDiff"
				, "08 88 88 88 88", null
	 ...
	 * objetDiff1AvecNull et objetDiff2AvecNull doivent avoir des attributs null.
	 */
	public static transient IUtilisateurCerbereDTO objetDiff2AvecNull 
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetCompApres 
		= new UtilisateurCerbereDTO("1"
				, M
				, "Stacy", "King"
				, "01 02 03 04 05", null
	 ...
	 */
	public static transient IUtilisateurCerbereDTO objetNullClone1;
	
	/**
	 * clone de objet1.<br/>
	 */
	public static transient IUtilisateurCerbereDTO objetClone1;
	...
	private static final Log LOG 
		= LogFactory.getLog(UtilisateurCerbereDTOTest.class);
	 ...
	 */
	public UtilisateurCerbereDTOTest() {
		super();
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testClone() ********** ");
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testToString() ********** ");
		}
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "UtilisateurCerbereDTO [id=0, civilite=null, prenom=null, nom=null, tel=null, email=null, service=null, unite=null, profil=null, portee=null, restriction=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "UtilisateurCerbereDTO [id=1, civilite=M., prenom=prenomTest, nom=nomTest, tel=01 60 52 34 51, email=test.test@yahoo.fr, service=CEREMA, unite=CEREMA/DTecITM/CITS/DACSI, profil=ADMINISTRATEUR, portee=null, restriction=null]"
						, objet1.toString());
	...
	public void testFournirEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testFournirEnTeteCsv() ********** ");
		}
	...
	public void testFournirStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testFournirStringCsv() ********** ");
		}
	...
	public void testFournirEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testFournirEnTeteColonne() ********** ");
		}
	...
	public void testFournirValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereDTOTest - méthode testFournirValeurColonne() ********** ");
		}
...
} // FIN DE LA CLASSE UtilisateurCerbereDTOTest.-----------------------------
