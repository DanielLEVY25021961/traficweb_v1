 ...
 *
 */
public class TeleversementDTOTest {
	 ...
	 * 2019-06-13_08_37_43
	 */
	public static final String DATE_TELEVERSEMENT_1 
		= "2019-06-13_08_37_43";
	 ...
	 * 2018-06-13_08_37_43
	 */
	public static final String DATE_TELEVERSEMENT_2 
		= "2018-06-13_08_37_43";
	 ...
	 * 2018-01-13_08_37_43
	 */
	public static final String DATE_TELEVERSEMENT_3 
		= "2018-01-13_08_37_43";
	...
	private static final Log LOG = LogFactory.getLog(TeleversementDTOTest.class);
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE TeleversementTest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE TeleversementTest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testClone() ********** ");
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testToString() ********** ");
		}
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "TeleversementDTO [id=null, dateTeleversement=null, utilisateur=null, gestionnaire=null, typeFichier=null, nomFichierTeleverse=null, fichierStockeServeur=null, anneeGestion=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "TeleversementDTO [id=1, dateTeleversement=2019-06-13_08_37_43, utilisateur=nomTest, gestionnaire=DIRA, typeFichier=HIT, nomFichierTeleverse=HITDIRA2018, fichierStockeServeur=toto, anneeGestion=2018]"
						, objet1.toString());
	...
	public void testFournirEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testFournirEnTeteCsv() ********** ");
		}
	...
	public void testFournirStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testFournirStringCsv() ********** ");
		}
	...
	public void testFournirEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testFournirEnTeteColonne() ********** ");
		}
	...
	public void testFournirValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE TeleversementTest - méthode testFournirValeurColonne() ********** ");
		}
...
} // FIN DE LA CLASSE TeleversementDTOTest.----------------------------------
