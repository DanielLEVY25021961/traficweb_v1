...
/**
 * CLASSE AnneeGestionDTOTest :<br/>
 * Test JUnit de la classe {@link AnneeGestionDTO}.<br/>
 * <br/>
 *
 ...
 *
 */
public class AnneeGestionDTOTest {
	 ...
	 */
	public static transient IAnneeGestionDTO objet1 
		= new AnneeGestionDTO("1", ANNEE_2018);
	
	/**
	 * objet1MemeInstance doit être la même instance que objet1.<br/>
	 */
	public static transient IAnneeGestionDTO objet1MemeInstance = objet1;
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IAnneeGestionDTO objet2EqualsObj1 
		=  new AnneeGestionDTO("2", ANNEE_2018);
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IAnneeGestionDTO objet3EqualsObj1 
		= new AnneeGestionDTO("3", ANNEE_2018);
	 ...
	 */
	public static transient IAnneeGestionDTO objetNull1 
		= new AnneeGestionDTO("0", null);
	 ...
	 * tous les attributs aux valeurs par défaut.
	 */
	public static transient IAnneeGestionDTO objetNull2 
		=  new AnneeGestionDTO("7", null);
	
	/**
	 * objet1AvecNull et objet2EqualsObjet1AvecNull 
	 * doivent être equals() et avoir certains attributs à null.
	 */
	public static transient IAnneeGestionDTO objet1AvecNull 
		= new AnneeGestionDTO("3", null);
	
	/**
	 * objet1AvecNull et objet2EqualsObjet1AvecNull 
	 * doivent être equals() et avoir certains attributs à null.
	 */
	public static transient IAnneeGestionDTO objet2EqualsObjet1AvecNull 
		= new AnneeGestionDTO("4", null);
	
	/**
	 * objetDiff1 doit être différent de objetDiff2
	 */
	public static transient IAnneeGestionDTO objetDiff1 
		= new AnneeGestionDTO("1", "2020");
	
	/**
	 * objetDiff2 doit être différent de objetDiff1
	 */
	public static transient IAnneeGestionDTO objetDiff2 
		= new AnneeGestionDTO("1", "2016");
	
	/**
	 * objetCompAvant doit être AVANT objetCompApres.
	 */
	public static transient IAnneeGestionDTO objetCompAvant 
		= new AnneeGestionDTO("1" , "2015");
	
	/**
	 * objetCompApres doit être APRES objetCompAvant.
	 */
	public static transient IAnneeGestionDTO objetCompApres 
		= new AnneeGestionDTO("1", "2016");
	
	/**
	 * clone de objetNull1.<br/>
	 */
	public static transient IAnneeGestionDTO objetNullClone1;
	
	/**
	 * clone de objet1.<br/>
	 */
	public static transient IAnneeGestionDTO objetClone1;
	...
	private static final Log LOG 
		= LogFactory.getLog(AnneeGestionDTOTest.class);
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE AnneeGestionTest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE AnneeGestionTest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testClone() ********** ");
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testToString() ********** ");
		}
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "AnneeGestionDTO [id=0, anneeGestion=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "AnneeGestionDTO [id=1, anneeGestion=2018]"
						, objet1.toString());
	...
	public void testFournirEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testFournirEnTeteCsv() ********** ");
		}
	...
	public void testFournirStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testFournirStringCsv() ********** ");
		}
	...
	public void testFournirEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testFournirEnTeteColonne() ********** ");
		}
	...
	public void testFournirValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE AnneeGestionTest - méthode testFournirValeurColonne() ********** ");
		}
...
} // FIN DE LA CLASSE AnneeGestionDTOTest.-----------------------------------
