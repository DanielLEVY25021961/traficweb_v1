...
/**
 * CLASSE UtilisateurCerbereModelObsTest :<br/>
 * Test JUnit de la classe UtilisateurCerbereModelObs.<br/>
 * <br/>
 *
 ...
 *
 */
public class UtilisateurCerbereModelObsTest {
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objet1 
		= new UtilisateurCerbereModelObs("1"
				, M
				, PRENOMTEST, NOMTEST
				, "01 60 52 34 51"
				, MAILTEST
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objet1MemeInstance = objet1;
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IUtilisateurCerbereModelObs objet2EqualsObj1 
		=  new UtilisateurCerbereModelObs("2"
				, M
				, PRENOMTEST, NOMTEST
				, "07 69 52 31 65"
				, MAILTEST
	 ...
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IUtilisateurCerbereModelObs objet3EqualsObj1 
		= new UtilisateurCerbereModelObs("3"
				, "Mlle"
				, PRENOMTEST, NOMTEST
				, "05 25 89 87 45"
				, MAILTEST
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetNull1 
		= new UtilisateurCerbereModelObs("0"
				, null
				, null, null
				, null, null
				, null, null
	 ...
	 * tous les attributs aux valeurs par défaut.
	 */
	public static transient IUtilisateurCerbereModelObs objetNull2 
		=  new UtilisateurCerbereModelObs("7"
				, null
				, null, null
				, null, null
				, null, null
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objet1AvecNull 
		= new UtilisateurCerbereModelObs("3"
				, "Mlle"
	 ...
	 * doivent être equals() et avoir certains attributs à null.
	 */
	public static transient IUtilisateurCerbereModelObs objet2EqualsObjet1AvecNull 
		= new UtilisateurCerbereModelObs("4"
				, "Mlle"
				, null, "nomTestavecNull"
				, "01 60 81 44 44", null
				, "SG", "SG"
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetDiff1 
		= new UtilisateurCerbereModelObs("4"
				, M
				, "Laurent", "Sergent"
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetDiff2 
		= new UtilisateurCerbereModelObs("1"
				, "Mme"
				, "Melanie", "Daisy"
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetDiff1AvecNull 
		= new UtilisateurCerbereModelObs("1"
				, M
				, null, "SergentDiff"
				, "08 88 88 88 88", null
	 ...
	 * objetDiff1AvecNull et objetDiff2AvecNull doivent avoir des attributs null.
	 */
	public static transient IUtilisateurCerbereModelObs objetDiff2AvecNull 
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetCompAvant 
		= new UtilisateurCerbereModelObs("1" 
				, M
				, "Stacy", "King"
				, "00 01 02 03 04", null
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetCompApres 
		= new UtilisateurCerbereModelObs("1"
				, M
				, "Stacy", "King"
				, "01 02 03 04 05", null
	 ...
	 */
	public static transient IUtilisateurCerbereModelObs objetNullClone1;
	
	/**
	 * clone de objet1.<br/>
	 */
	public static transient IUtilisateurCerbereModelObs objetClone1;
	...
	private static final Log LOG 
		= LogFactory.getLog(UtilisateurCerbereModelObsTest.class);
	 ...
	 */
	public UtilisateurCerbereModelObsTest() {
		super();
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testClone() ********** ");
		}
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println("objetClone1 : " 
					+ objetClone1.toString());
			System.out.println();
			System.out.println("objet1 == objetClone1 : " + (objet1 == objetClone1));    // NOPMD by dan on 01/05/19 09:11
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testToString() ********** ");
		}
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "UtilisateurCerbereModelObs [id=0, civilite=null, prenom=null, nom=null, tel=null, email=null, service=null, unite=null, profil=null, portee=null, restriction=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "UtilisateurCerbereModelObs [id=1, civilite=M., prenom=prenomTest, nom=nomTest, tel=01 60 52 34 51, email=test.test@yahoo.fr, service=CEREMA, unite=CEREMA/DTecITM/CITS/DACSI, profil=ADMINISTRATEUR, portee=null, restriction=null]"
						, objet1.toString());
	...
	public void testFournirEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testFournirEnTeteCsv() ********** ");
		}
	...
	public void testFournirStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testFournirStringCsv() ********** ");
		}
	...
	public void testFournirEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testFournirEnTeteColonne() ********** ");
		}
	...
	public void testFournirValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE UtilisateurCerbereModelObsTest - méthode testFournirValeurColonne() ********** ");
		}
...
} // FIN DE LA CLASSE UtilisateurCerbereModelObsTest.------------------------
