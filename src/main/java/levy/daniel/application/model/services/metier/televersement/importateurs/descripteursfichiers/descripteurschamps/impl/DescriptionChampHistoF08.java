 ...
 * 
 * <p>
 * Un DescriptionChampHistoF08 "sait" qu'une description 
 * de fichier HISTO_F08 doit être ordonnée comme suit :<br/>
 ...
 * 
 * <p>
 * Un DescriptionChampHistoF08 ne "connait" les valeurs 
 ...
 * = new DescriptionChampHistoF08();</b></code><br/>
 ...
 *
 */
public class DescriptionChampHistoF08 extends AbstractDescriptionChampAscii {

	// ************************ATTRIBUTS************************************/
	/* CONSTANTES. */
	/**
	 * CLASSE_DESCRIPTIONCHAMPHISTOF08 : String : <br/>
	 * "CLASSE DescriptionChampHistoF08 - ".<br/>
	 */
	public static final String CLASSE_DESCRIPTIONCHAMPHISTOF08
		= "CLASSE DescriptionChampHistoF08 - ";
	...
	private static final Log LOG = LogFactory
			.getLog(DescriptionChampHistoF08.class);

	
	// *************************METHODES************************************/
	
	/**
	 * method CONSTRUCTEUR DescriptionChampHistoF08() :<br/>
	 * <br/>
	 * CONSTRUCTEUR D'ARITE 0 permettant d'instancier
	 * un DescriptionChampHistoF08 en instanciant et alimentant
	 ...
	 *
	 */
	public DescriptionChampHistoF08() throws Exception {
		
		super();
		
	} // Fin de CONSTRUCTEUR DescriptionChampHistoF08().___________________
	
	
	
	/**
	 * method CONSTRUCTEUR DescriptionChampHistoF08(
	 * SortedMap&lt;Integer, String&gt; pColonnesDescriptionMap) :
	 * CONSTRUCTEUR D'ARITE 1.<br/>
	 * <br/>
	 * - Permet de construire un DescriptionChampHistoF08
	 ...
	 * <br/>
	 *
	 * @return : String : "descriptionchamphistof08.niveau.anomalie" 
	 * pour un DescriptionChampHistoF08.<br/>
	 */
	@Override
	public final String recupererCleNiveauAnomalie() {
		return "descriptionchamphistof08.niveau.anomalie";
	 ...
	 * <br/>
	 *
	 * @return : String : "descriptionchamphistof08.log.erreur" 
	 * pour un DescriptionChampHistoF08.<br/>
	 */
	@Override
	public final String recupererCleLogErreur() {
		return "descriptionchamphistof08.log.erreur";
	} // Fin de recupererCleNiveauAnomalie().______________________________
	...
	public final String getNomClasse() {
		return CLASSE_DESCRIPTIONCHAMPHISTOF08;
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.anomenclaturetrue".<br/>
	 */
	@Override
	public final String getCleANomenclatureTrue() {
		return "descriptionchamphistof08.lirechamp.anomenclaturetrue";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.alexiquetrue".<br/>
	 */
	@Override
	public final String getCleALexiqueTrue() {
		return "descriptionchamphistof08.lirechamp.alexiquetrue";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.tableaunull".<br/>
	 */
	@Override
	public final String getCleTableauNull() {
		return "descriptionchamphistof08.lirechamp.tableaunull";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.tableauvide".<br/>
	 */
	@Override
	public final String getCleTableauVide() {
		return "descriptionchamphistof08.lirechamp.tableauvide";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.tableautroppetit".<br/>
	 */
	@Override
	public final String getCleTableauTropPetit() {
		return "descriptionchamphistof08.lirechamp.tableautroppetit";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.ordrechampvide".<br/>
	 */
	@Override
	public final String getCleOrdreChampVide() {
		return "descriptionchamphistof08.lirechamp.ordrechampvide";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.colonnevide".<br/>
	 */
	@Override
	public final String getCleColonneVide() {
		return "descriptionchamphistof08.lirechamp.colonnevide";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.intitulevide".<br/>
	 */
	@Override
	public final String getCleIntituleVide() {
		return "descriptionchamphistof08.lirechamp.intitulevide";
	...
	/**
	 * {@inheritDoc}
	 * "descriptionchamphistof08.lirechamp.champjavavide".<br/>
	 */
	@Override
	public final String getCleChampJavaVide() {
		return "descriptionchamphistof08.lirechamp.champjavavide";
	...
	/**
	* {@inheritDoc}
	* "descriptionchamphistof08.lirechamp.typejavavide".<br/>
	*/
	@Override
	public final String getCleTypeJavaVide() {
	return "descriptionchamphistof08.lirechamp.typejavavide";
	...
	/**
	* {@inheritDoc}
	* "descriptionchamphistof08.lirechamp.anomenclaturevide".<br/>
	*/
	@Override
	public final String getCleANomenclatureVide() {
	return "descriptionchamphistof08.lirechamp.anomenclaturevide";
...
} // FIN DE LA CLASSE DescriptionChampHistoF08.------------------------------
