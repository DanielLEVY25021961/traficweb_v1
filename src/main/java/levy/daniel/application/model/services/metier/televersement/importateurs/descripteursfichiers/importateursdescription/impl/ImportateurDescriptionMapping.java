...
public class ImportateurDescriptionMapping extends
	...
	public final SortedMap<Integer, IDescriptionChamp> importerDescription(
		...
		/* OUVERTURE DES FLUX. */
		final FileInputStream fis = new FileInputStream(fileDescription); // NOPMD by daniel.levy on 12/07/19 15:44
		final InputStreamReader isr = new InputStreamReader(fis, charset); // NOPMD by daniel.levy on 12/07/19 15:44
		final BufferedReader bfr = new BufferedReader(isr); // NOPMD by daniel.levy on 12/07/19 15:44
