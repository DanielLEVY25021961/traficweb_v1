package levy.daniel.application.model.services.valideurs.metier.sections;
...
/**
 * INTERFACE ISectionHitValideurService :<br/>
 ...
 *
 */
public interface ISectionHitValideurService {
	 ...
	 * <br/>
	 *
	 * @param pDto : ISectionHitDTO : DTO.<br/>
	 * @return : ErreursMaps : 
	 ...
	 * @throws Exception 
	 */
	ErreursMaps valider(ISectionHitDTO pDto) 
			throws Exception;
