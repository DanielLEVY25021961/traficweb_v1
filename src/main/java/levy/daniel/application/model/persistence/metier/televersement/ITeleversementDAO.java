...
/**
 * INTERFACE ITeleversementDAO :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public interface ITeleversementDAO {
	 ...
	 * @throws Exception
	 */
	ITeleversement create(ITeleversement pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	ITeleversement createOrRetrieve(ITeleversement pEntity) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(ITeleversement pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(ITeleversement pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;ITeleversement&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;ITeleversement&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<ITeleversement> saveIterable(Iterable<ITeleversement> pList) 
				throws Exception;
	 ...
	 * @throws Exception
	 */
	ITeleversement retrieve(ITeleversement pObject) throws Exception;
	 ...
	 * 
	 * @return : ITeleversement : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	ITeleversement findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(ITeleversement pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<ITeleversement> findAll() throws Exception;
	 ...
	 * @throws Exception
	 */
	List<ITeleversement> findAllMax(
	 ...
	 * (List&lt;ITeleversement&gt;) dont les IDs appartiennent 
	 ...
	 * 
	 * @return Iterable&lt;ITeleversement&gt; : 
	 * List&lt;ITeleversement&gt;.<br/>
	 * 
	 * @throws Exception 
	 */
	Iterable<ITeleversement> findAllIterable(Iterable<Long> pIds) throws Exception;
	 ...
	 * @throws Exception 
	 */
	ITeleversement update(ITeleversement pObject) throws Exception;
	 ...
	 * @param pObjectModifie : ITeleversement : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return ITeleversement : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	ITeleversement updateById(Long pId, ITeleversement pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : ITeleversement : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(ITeleversement pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<ITeleversement> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<ITeleversement> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : ITeleversement : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(ITeleversement pObject) throws Exception;
	 ...
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<ITeleversement> pList);
...
} // FIN DE L'INTERFACE ITeleversementDAO.-----------------------------------
