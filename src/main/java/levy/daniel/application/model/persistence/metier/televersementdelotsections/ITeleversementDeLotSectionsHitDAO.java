...
/**
 * INTERFACE ITeleversementDeLotSectionsHitDAO :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public interface ITeleversementDeLotSectionsHitDAO {
	 ...
	 * @throws Exception
	 */
	ITeleversementDeLotSectionsHit create(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	ITeleversementDeLotSectionsHit createOrRetrieve(ITeleversementDeLotSectionsHit pEntity) 
															throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;ITeleversementDeLotSectionsHit&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;ITeleversementDeLotSectionsHit&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<ITeleversementDeLotSectionsHit> saveIterable(Iterable<ITeleversementDeLotSectionsHit> pList) 
				throws Exception;
	 ...
	 * @throws Exception
	 */
	ITeleversementDeLotSectionsHit retrieve(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * 
	 * @return : ITeleversementDeLotSectionsHit : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	ITeleversementDeLotSectionsHit findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * 
	 * @return List&lt;ITeleversementDeLotSectionsHit&gt; : 
	 * liste des objets métier dont au moins 1 des attributs 
	 * de equals contient pString.<br/>
	 * 
	 * @throws Exception
	 */
	List<ITeleversementDeLotSectionsHit> rechercherRapide(
	 ...
	 * @throws Exception
	 */
	List<ITeleversementDeLotSectionsHit> findAll() throws Exception;
	 ...
	 * @throws Exception
	 */
	List<ITeleversementDeLotSectionsHit> findAllMax(
	 ...
	 * (List&lt;ITeleversementDeLotSectionsHit&gt;) dont les IDs appartiennent 
	 ...
	 * 
	 * @return Iterable&lt;ITeleversementDeLotSectionsHit&gt; : 
	 * List&lt;ITeleversementDeLotSectionsHit&gt;.<br/>
	 * 
	 * @throws Exception 
	 */
	Iterable<ITeleversementDeLotSectionsHit> findAllIterable(Iterable<Long> pIds) throws Exception;
	 ...
	 * @throws Exception 
	 */
	ITeleversementDeLotSectionsHit update(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * @param pObjectModifie : ITeleversementDeLotSectionsHit : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return ITeleversementDeLotSectionsHit : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	ITeleversementDeLotSectionsHit updateById(Long pId, ITeleversementDeLotSectionsHit pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : ITeleversementDeLotSectionsHit : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<ITeleversementDeLotSectionsHit> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<ITeleversementDeLotSectionsHit> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : ITeleversementDeLotSectionsHit : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(ITeleversementDeLotSectionsHit pObject) throws Exception;
	 ...
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<ITeleversementDeLotSectionsHit> pList);
...
} // FIN DE L'INTERFACE ITeleversementDeLotSectionsHitDAO.-------------------
