...
public class SectionHitDAOJPASpring implements ISectionHitDAO {
	...
	private Query fournirRequeteParametree(
		...
		requeteString
			= SELECT_OBJET
			+ "and sectionHit.numDepartement == :pNumDepartement "
			+ "and sectionHit.numSection == :pNumSection "
			+ "and sectionHit.sens == :pSens "
			+ "and sectionHit.nature == :pNature "
			+ "and sectionHit.classe == :pClasse "
			+ "and sectionHit.anneeTraitement == :pAnneeTraitement "
			+ "and sectionHit.zoneLibre1 == :pZoneLibre1 "
			+ "and sectionHit.numRoute == :pNumRoute "
			+ "and sectionHit.indiceNumRoute == :pIndiceNumRoute "
			+ "and sectionHit.indiceLettreRoute == :pIndiceLettreRoute "
			+ "and sectionHit.categorieAdminRoute == :pCategorieAdminRoute "
			+ "and sectionHit.typeComptage == :pTypeComptage "
			+ "and sectionHit.classementRoute == :pClassementRoute "
			+ "and sectionHit.classeLargeurChausseeU == :pClasseLargeurChausseeU "
			+ "and sectionHit.classeLargeurChausseesS == :pClasseLargeurChausseesS "
			+ "and sectionHit.typeReseau == :pTypeReseau "
			+ "and sectionHit.pRoupK == :pPRoupK "
			+ "and sectionHit.lieuDitOrigine == :pLieuDitOrigine "
			+ "and sectionHit.prOrigine == :pPrOrigine "
			+ "and sectionHit.absOrigine == :pAbsOrigine "
			+ "and sectionHit.lieuDitExtremite == :pLieuDitExtremite "
			+ "and sectionHit.prExtremite == :pPrExtremite "
			+ "and sectionHit.absExtremite == :pAbsExtremite "
			+ "and sectionHit.lieuDitComptage == :pLieuDitComptage "
			+ "and sectionHit.prComptage == :pPrComptage "
			+ "and sectionHit.absComptage == :pAbsComptage "
			+ "and sectionHit.longueurSection == :pLongueurSection "
			+ "and sectionHit.longueurRaseCampagne == :pLongueurRaseCampagne "
			+ "and sectionHit.numDepartementRattachement == :pNumDepartementRattachement "
			+ "and sectionHit.numSectionRattachement == :pNumSectionRattachement "
			+ "and sectionHit.sensRattachement == :pSensRattachement "
			+ "and sectionHit.numDepartementLimitrophe == :pNumDepartementLimitrophe "
			+ "and sectionHit.numSectionLimitrophe == :pNumSectionLimitrophe "
			+ "and sectionHit.sensLimitrophe == :pSensLimitrophe "
			+ "and sectionHit.moisSectionnement == :pMoisSectionnement "
			+ "and sectionHit.anneeSectionnement == :pAnneeSectionnement "
			+ "and sectionHit.zoneLibre2 == :pZoneLibre2 "
			+ "and sectionHit.mjaN == :pMjaN "
			+ "and sectionHit.modeCalculN == :pModeCalculN "
			+ "and sectionHit.pcPLN == :pPcPLN "
			+ "and sectionHit.evaluationPLN == :pEvaluationPLN "
			+ "and sectionHit.pcNuitAnnuelN == :pPcNuitAnnuelN "
			+ "and sectionHit.indiceFiabiliteMjaN == :pIndiceFiabiliteMjaN "
			+ "and sectionHit.mjmNmois01 == :pMjmNmois01 "
			+ "and sectionHit.pcNuitNmois01 == :pPcNuitNmois01 "
			+ "and sectionHit.mjmNmois02 == :pMjmNmois02 "
			+ "and sectionHit.pcNuitNmois02 == :pPcNuitNmois02 "
			+ "and sectionHit.mjmNmois03 == :pMjmNmois03 "
			+ "and sectionHit.pcNuitNmois03 == :pPcNuitNmois03 "
			+ "and sectionHit.mjmNmois04 == :pMjmNmois04 "
			+ "and sectionHit.pcNuitNmois04 == :pPcNuitNmois04 "
			+ "and sectionHit.mjmNmois05 == :pMjmNmois05 "
			+ "and sectionHit.pcNuitNmois05 == :pPcNuitNmois05 "
			+ "and sectionHit.mjmNmois06 == :pMjmNmois06 "
			+ "and sectionHit.pcNuitNmois06 == :pPcNuitNmois06 "
			+ "and sectionHit.mjmNmois07 == :pMjmNmois07 "
			+ "and sectionHit.pcNuitNmois07 == :pPcNuitNmois07 "
			+ "and sectionHit.mjmNmois08 == :pMjmNmois08 "
			+ "and sectionHit.pcNuitNmois08 == :pPcNuitNmois08 "
			+ "and sectionHit.mjmNmois09 == :pMjmNmois09 "
			+ "and sectionHit.pcNuitNmois09 == :pPcNuitNmois09 "
			+ "and sectionHit.mjmNmois10 == :pMjmNmois10 "
			+ "and sectionHit.pcNuitNmois10 == :pPcNuitNmois10 "
			+ "and sectionHit.mjmNmois11 == :pMjmNmois11 "
			+ "and sectionHit.pcNuitNmois11 == :pPcNuitNmois11 "
			+ "and sectionHit.mjmNmois12 == :pMjmNmois12 "
			+ "and sectionHit.pcNuitNmois12 == :pPcNuitNmois12 "
			+ "and sectionHit.zoneLibre3 == :pZoneLibre3 "
			+ "and sectionHit.anneeNmoins1 == :pAnneeNmoins1 "
			+ "and sectionHit.mjaNmoins1 == :pMjaNmoins1 "
			+ "and sectionHit.typeComptageNmoins1 == :pTypeComptageNmoins1 "
			+ "and sectionHit.modeCalculNmoins1 == :pModeCalculNmoins1 "
			+ "and sectionHit.pcPLNmoins1 == :pPcPLNmoins1 "
			+ "and sectionHit.evaluationPLNmoins1 == :pEvaluationPLNmoins1 "
			+ "and sectionHit.pcNuitAnnuelNmoins1 == :pPcNuitAnnuelNmoins1 "
			+ "and sectionHit.indiceFiabiliteMjaNmoins1 == :pIndiceFiabiliteMjaNmoins1 "
			+ "and sectionHit.anneeNmoins2 == :pAnneeNmoins2 "
			+ "and sectionHit.mjaNmoins2 == :pMjaNmoins2 "
			+ "and sectionHit.typeComptageNmoins2 == :pTypeComptageNmoins2 "
			+ "and sectionHit.modeCalculNmoins2 == :pModeCalculNmoins2 "
			+ "and sectionHit.pcPLNmoins2 == :pPcPLNmoins2 "
			+ "and sectionHit.evaluationPLNmoins2 == :pEvaluationPLNmoins2 "
			+ "and sectionHit.pcNuitAnnuelNmoins2 == :pPcNuitAnnuelNmoins2 "
			+ "and sectionHit.indiceFiabiliteMjaNmoins2 == :pIndiceFiabiliteMjaNmoins2 "
			+ "and sectionHit.anneeNmoins3 == :pAnneeNmoins3 "
			+ "and sectionHit.mjaNmoins3 == :pMjaNmoins3 "
			+ "and sectionHit.typeComptageNmoins3 == :pTypeComptageNmoins3 "
			+ "and sectionHit.modeCalculNmoins3 == :pModeCalculNmoins3 "
			+ "and sectionHit.pcPLNmoins3 == :pPcPLNmoins3 "
			+ "and sectionHit.evaluationPLNmoins3 == :pEvaluationPLNmoins3 "
			+ "and sectionHit.pcNuitAnnuelNmoins3 == :pPcNuitAnnuelNmoins3 "
			+ "and sectionHit.indiceFiabiliteMjaNmoins3 == :pIndiceFiabiliteMjaNmoins3 "
			+ "and sectionHit.anneeNmoins4 == :pAnneeNmoins4 "
			+ "and sectionHit.mjaNmoins4 == :pMjaNmoins4 "
			+ "and sectionHit.typeComptageNmoins4 == :pTypeComptageNmoins4 "
			+ "and sectionHit.modeCalculNmoins4 == :pModeCalculNmoins4 "
			+ "and sectionHit.pcPLNmoins4 == :pPcPLNmoins4 "
			+ "and sectionHit.evaluationPLNmoins4 == :pEvaluationPLNmoins4 "
			+ "and sectionHit.pcNuitAnnuelNmoins4 == :pPcNuitAnnuelNmoins4 "
			+ "and sectionHit.indiceFiabiliteMjaNmoins4 == :pIndiceFiabiliteMjaNmoins4 "
			+ "and sectionHit.anneeNmoins5 == :pAnneeNmoins5 "
			+ "and sectionHit.mjaNmoins5 == :pMjaNmoins5 "
			+ "and sectionHit.typeComptageNmoins5 == :pTypeComptageNmoins5 "
			+ "and sectionHit.modeCalculNmoins5 == :pModeCalculNmoins5 "
			+ "and sectionHit.pcPLNmoins5 == :pPcPLNmoins5 "
			+ "and sectionHit.evaluationPLNmoins5 == :pEvaluationPLNmoins5 "
			+ "and sectionHit.pcNuitAnnuelNmoins5 == :pPcNuitAnnuelNmoins5 "
			+ "and sectionHit.indiceFiabiliteMjaNmoins5 == :pIndiceFiabiliteMjaNmoins5 "
			+ "and sectionHit.mjmNmoins1mois01 == :pMjmNmoins1mois01 "
			+ "and sectionHit.pcNuitNmoins1mois01 == :pPcNuitNmoins1mois01 "
			+ "and sectionHit.mjmNmoins1mois02 == :pMjmNmoins1mois02 "
			+ "and sectionHit.pcNuitNmoins1mois02 == :pPcNuitNmoins1mois02 "
			+ "and sectionHit.mjmNmoins1mois03 == :pMjmNmoins1mois03 "
			+ "and sectionHit.pcNuitNmoins1mois03 == :pPcNuitNmoins1mois03 "
			+ "and sectionHit.mjmNmoins1mois04 == :pMjmNmoins1mois04 "
			+ "and sectionHit.pcNuitNmoins1mois04 == :pPcNuitNmoins1mois04 "
			+ "and sectionHit.mjmNmoins1mois05 == :pMjmNmoins1mois05 "
			+ "and sectionHit.pcNuitNmoins1mois05 == :pPcNuitNmoins1mois05 "
			+ "and sectionHit.mjmNmoins1mois06 == :pMjmNmoins1mois06 "
			+ "and sectionHit.pcNuitNmoins1mois06 == :pPcNuitNmoins1mois06 "
			+ "and sectionHit.mjmNmoins1mois07 == :pMjmNmoins1mois07 "
			+ "and sectionHit.pcNuitNmoins1mois07 == :pPcNuitNmoins1mois07 "
			+ "and sectionHit.mjmNmoins1mois08 == :pMjmNmoins1mois08 "
			+ "and sectionHit.pcNuitNmoins1mois08 == :pPcNuitNmoins1mois08 "
			+ "and sectionHit.mjmNmoins1mois09 == :pMjmNmoins1mois09 "
			+ "and sectionHit.pcNuitNmoins1mois09 == :pPcNuitNmoins1mois09 "
			+ "and sectionHit.mjmNmoins1mois10 == :pMjmNmoins1mois10 "
			+ "and sectionHit.pcNuitNmoins1mois10 == :pPcNuitNmoins1mois10 "
			+ "and sectionHit.mjmNmoins1mois11 == :pMjmNmoins1mois11 "
			+ "and sectionHit.pcNuitNmoins1mois11 == :pPcNuitNmoins1mois11 "
			+ "and sectionHit.mjmNmoins1mois12 == :pMjmNmoins1mois12 "
			+ "and sectionHit.pcNuitNmoins1mois12 == :pPcNuitNmoins1mois12 "
			+ "and sectionHit.zoneLibre4 == :pZoneLibre4";
		...
		/* Passage des paramètres de la requête JPQL. */
			...
			requete.setParameter("pLieuDitOrigine", pObject.getLieuDitOrigine());
			requete.setParameter("pPrOrigine", pObject.getPrOrigine());
			requete.setParameter("pAbsOrigine", pObject.getAbsOrigine());
			requete.setParameter("pLieuDitExtremite", pObject.getLieuDitExtremite());
			requete.setParameter("pPrExtremite", pObject.getPrExtremite());
			requete.setParameter("pAbsExtremite", pObject.getAbsExtremite());
			requete.setParameter("pLieuDitComptage", pObject.getLieuDitComptage());
			requete.setParameter("pPrComptage", pObject.getPrComptage());
			requete.setParameter("pAbsComptage", pObject.getAbsComptage());
	...
	public ISectionHit create(
		...
		try {
			 ...
			 * DANS LE COMPOSITE. */
			entity.setLocalisation(utilisateurEntityPersiste);
