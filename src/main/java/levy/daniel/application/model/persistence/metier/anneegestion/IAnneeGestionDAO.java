 ...
 *
 */
public interface IAnneeGestionDAO {
	 ...
	 * @throws Exception
	 */
	void persist(IAnneeGestion pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IAnneeGestion pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;IAnneeGestion&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;IAnneeGestion&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<IAnneeGestion> saveIterable(Iterable<IAnneeGestion> pList) 
				throws Exception;
	 ...
	 * @throws Exception
	 */
	IAnneeGestion retrieve(IAnneeGestion pObject) throws Exception;
	 ...
	 * 
	 * @return : IAnneeGestion : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	IAnneeGestion findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IAnneeGestion pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IAnneeGestion> findAll() throws Exception;
	 ...
	 * (List&lt;IAnneeGestion&gt;) dont les IDs appartiennent 
	 ...
	 * 
	 * @return Iterable&lt;IAnneeGestion&gt; : 
	 * List&lt;IAnneeGestion&gt;.<br/>
	 * 
	 * @throws Exception 
	 */
	Iterable<IAnneeGestion> findAllIterable(Iterable<Long> pIds) throws Exception;
	 ...
	 * @throws Exception 
	 */
	IAnneeGestion update(IAnneeGestion pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IAnneeGestion : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IAnneeGestion : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	IAnneeGestion updateById(Long pId, IAnneeGestion pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IAnneeGestion : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IAnneeGestion pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IAnneeGestion> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IAnneeGestion> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IAnneeGestion : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IAnneeGestion pObject) throws Exception;
	 ...
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IAnneeGestion> pList);
...
} // FIN DE L'INTERFACE IAnneeGestionDAO.------------------------------------
